System.register(['angular2/core', 'angular2/http', 'rxjs/Rx', "./products/product-list.component", "./products/product.service", 'angular2/router', "./home/welcome.component", "./products/product-detail.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, product_list_component_1, product_service_1, router_1, welcome_component_1, product_detail_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.pageTitle = 'Computools Product Management';
                }
